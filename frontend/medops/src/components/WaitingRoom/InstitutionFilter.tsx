    ...
    <>
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {selectedInstitutionId && (
            <XMarkIcon 
              className="w-5 h-5 ml-1 hover:text-white/70" 
      ...
      {isOpen && createPortal(
        <>
          ...
          <div 
            ...
            className="z-[10001] bg-[#1a1a1b] border border-white/15 rounded-xl shadow-2xl"
            ...
            <div className="p-4 space-y-2">
              ...
              <div className="max-h-60 overflow-y-auto">
                <button
                  ...
                  className="flex items-center justify-between w-full px-4 py-3 hover:bg-white/5 rounded-xl text-sm text-white/40 hover:text-white/70"
                >
                ...
                {institutions.map((inst: any) => (
                  <button
                    ...
                    className="flex items-center justify-between w-full px-4 py-3 hover:bg-white/5 rounded-xl group"
                  >
                    <span className="text-sm text-white/60 group-hover:text-white/90 truncate pr-4">
                      {inst.name}
                    </span>
                    {selectedInstitutionId === inst.id && <CheckIcon className="w-5 h-5 text-emerald-400" />}
                  </button>
                ))}
              </div>
            </div>
