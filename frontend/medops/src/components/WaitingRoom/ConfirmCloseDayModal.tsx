...
const ConfirmCloseDayModal: React.FC<ConfirmCloseDayModalProps> = ({ onConfirm, onCancel }) => {
  return (
    ...
    >
      <div
        className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 max-w-md w-full animate-fade-slide"
      ...
      >
        ...
        <div className="flex gap-2 justify-end">
          ...
          <button
            className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm rounded-md bg-gray-100 text-gray-700 border border-gray-300 hover:bg-gray-200 transition-colors"
            onClick={onCancel}
          >
            No
          </button>
