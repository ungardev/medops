...
export default function FamilyHistorySection({ items, patientId, onRefresh }: Props) {
    ...
    if (editingItem) {
      update.mutate(
        { ...editingItem, ...data },
        {
          ...
          onError: () =>
            setLocalError("No se pudo actualizar el antecedente familiar. Intenta nuevamente."),
        }
      );
    } else {
      create.mutate(
        { ...data, patient: patientId },
        {
          ...
          onError: () =>
            setLocalError("No se pudo crear el antecedente familiar. Intenta nuevamente."),
        }
      );
    }
  };
  ...
  const handleDelete = (id: number) => {
    ...
    remove.mutate(id, {
      ...
      onError: () =>
        setLocalError("No se pudo eliminar el antecedente familiar. Intenta nuevamente."),
    });
  };
