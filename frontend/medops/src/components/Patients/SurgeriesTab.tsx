    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          disabled={isSaving}
          className="flex items-center gap-2 px-3 py-1.5 bg-[var(--palantir-active)] hover:bg-[var(--palantir-active)]/90 text-white text-[9px] font-bold uppercase tracking-widest rounded-sm disabled:opacity-50"
        >
