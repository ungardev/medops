  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#1a1a1b] border border-white/15 w-full max-w-md rounded-xl overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-white/10 bg-emerald-500/5">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div>
            <label className="text-xs font-medium uppercase tracking-wider text-white/40 block mb-2">
              Monto Recibido
            </label>
            <div className="relative">
              ...
              <input
                ...
                required
                step="0.01"
                className="w-full bg-white/5 border border-white/15 p-4 pl-9 text-xl font-semibold text-emerald-400 outline-none focus:border-emerald-500/50 transition-all rounded-xl"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              className="w-full bg-white/5 border border-white/15 p-4 text-sm text-white/80 outline-none focus:border-emerald-500/50 transition-all resize-none placeholder:text-white/20 rounded-xl"
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 py-3 bg-emerald-500/15 text-emerald-400 text-sm font-medium hover:bg-emerald-500/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 rounded-xl border border-emerald-500/25"
            >
              {mutation.isPending ? (
                <>
            ...
            <button
              type="button"
              onClick={onClose}
              className="py-3 px-6 bg-white/5 text-white/50 text-sm font-medium hover:bg-white/10 hover:text-white/70 transition-all rounded-xl"
            >
              Cancelar
            </button>
          </div>
