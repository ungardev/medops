...
export const InstitutionCard = ({ 
  ...
  return (
    <div className="group relative bg-[#0A0A0A] border border-white/5 p-6 hover:border-emerald-500/30 transition-all duration-500 shadow-xl">
      {/* Indicador de Estado */}
      <div className={`absolute top-0 right-0 w-1 h-full ${isActive ? 'bg-emerald-500/50' : 'bg-red-500/50'}`} />
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className={`text-[9px] font-black ${isActive ? 'text-emerald-500' : 'text-red-500'}`}>
