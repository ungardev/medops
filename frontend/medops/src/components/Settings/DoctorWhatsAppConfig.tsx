  ...
  return (
    <div className="bg-white/5 border border-white/10 p-5 rounded-xl space-y-4">
      <div className="flex items-center gap-3">
        <DocumentTextIcon className="w-5 h-5 text-white/30" />
      ...
      <div className="space-y-3">
        <div className="bg-blue-500/5 border border-blue-500/10 p-4 rounded-xl">
          <div className="flex items-center gap-3 mb-2">
            <BellIcon className="w-4 h-4 text-blue-400/60" />
            <span className="text-sm text-blue-400/70 font-medium">Recordatorio de Cita</span>
          </div>
        ...
        <div className="bg-emerald-500/5 border border-emerald-500/10 p-4 rounded-xl">
          <div className="flex items-center gap-3 mb-2">
            <CurrencyDollarIcon className="w-4 h-4 text-emerald-400/60" />
            <span className="text-sm text-emerald-400/70 font-medium">Confirmación de Pago</span>
          </div>
          <p className="text-sm text-white/40 italic">
  ...
  return (
    <div className="bg-white/5 border border-white/10 p-4 rounded-xl">
      <div className="flex items-center gap-3 mb-3">
        <CheckCircleIcon className="w-5 h-5 text-white/30" />
        <span className="text-xs font-medium text-white/50 uppercase tracking-wider">
          Validación Local
        </span>
      </div>
    ...
    return (
      <div className="bg-white/5 border border-white/15 p-6 rounded-xl space-y-5">
        <div className="flex items-center justify-between">
          ...
          <div className="px-3 py-1.5 rounded-lg text-sm font-medium bg-white/5 text-white/30 border border-white/10">
            Inactivo
          </div>
        </div>
        ...
        <div className="bg-white/5 border border-dashed border-white/10 p-6 rounded-xl text-center">
          <WhatsAppIcon />
          <p className="text-sm text-white/40 mt-4 mb-2">
        ...
        <button 
          ...
          className="w-full py-3 px-5 bg-green-500/10 border border-green-500/20 text-green-400 text-sm font-medium hover:bg-green-500/15 transition-all rounded-xl"
        >
          Configurar WhatsApp
        </button>
      </div>
        ...
        {isConfigured ? (
          <>
            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-xl">
              ...
              <div className="bg-black/20 p-3 rounded font-mono text-sm text-emerald-400/70 break-all">
                {callbackUrl}
              </div>
          ...
          <p className="text-sm text-white/30">
            WhatsApp habilitado pero incompleto. Complete los campos para activar.
          </p>
        )}
  ...
  return (
    <div className="bg-white/5 border border-white/15 p-6 rounded-xl space-y-5">
      ...
      <div className="flex items-center gap-4">
        ...
        />
        <label htmlFor="whatsapp_enabled" className="text-white/60 text-sm font-medium">
