  ...
  if (isLoading || servicesLoading) return (
    <div className="p-8 flex items-center justify-center min-h-[400px]">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-xs text-emerald-400/60">Cargando datos de la cola...</p>
      </div>
    </div>
  );
    ...
    <div className="space-y-6">
      ...
      {patientEntry && allEntries.length > 0 && (
        <div className="bg-white/10 border border-white/20 rounded-xl overflow-hidden">
          <div className="px-5 py-3 border-b border-white/20 bg-white/5 flex items-center justify-between">
