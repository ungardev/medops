...
# --- Crear citas en distintos estados y fechas ---
today = date.today()
...
for i, p in enumerate(pacientes, start=1):
    # Distribuir fechas: algunos hoy, otros ayer, otros mañana
...
# --- Waiting Room: solo los de hoy en estado arrived o in_consultation ---
order_counter = 1
...
# --- Pagos: algunos completos, otros parciales ---
for appt in appointments:
...
print("✅ Base de datos repoblada con dataset extendido (10 pacientes, citas en varios estados, pagos, diagnósticos, tratamientos y prescripciones).")
